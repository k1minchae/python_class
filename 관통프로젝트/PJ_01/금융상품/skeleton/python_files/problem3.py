...
def get_deposit_products():
    ...
    new_dict = {}
    new_dict['금융상품코드'] = option_list[0]['fin_prdt_cd']
    new_dict['금융회사 코드'] = option_list[0]['fin_co_no']
    new_dict['저축 금리'] = option_list[0]['intr_rate']
    new_dict['저축금리유형'] = option_list[0]['intr_rate_type']
    new_dict['저축금리유형명'] = option_list[0]['intr_rate_type_nm']
    new_dict['최고 우대금리'] = option_list[0]['intr_rate2']
    new_dict = [new_dict]
    return new_dict
